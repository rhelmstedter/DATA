...
***** TODO Add a sheet with of all students in detention :@Helmstedter:
DEADLINE: <2023-03-10 Fri>
\n
*Due*: <2023-03-10 Fri>
*Status*: Need to have first and last name in separate columns and organized by date.
...
**** DONE Create SOP Documents :@Helmstedter:
DEADLINE: <2023-03-07 Tue>
\n
*Due*: <2023-03-07 Tue>
*Status*: [[https://docs.google.com/presentation/d/1NfwnuXgB5gd1C_e6LrII6EnhBy05muwb/edit?usp=sharing&ouid=103300073545602807799&rtpof=true&sd=true][Slideshow]] and [[https://github.com/rhelmstedter/DATA/blob/main/dealing-with-disrespect/detention_SOP.pdf][handout]] are complete.
** Admin Support [2/4]
